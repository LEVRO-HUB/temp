                    ...
                    {roles.map(role => {
                      ...
                      return (
                        <div 
                          ...
                          className={`flex flex-col items-center justify-center p-4 rounded-xl border-2 transition-all cursor-pointer shadow-sm group ${
                            isSelected 
                    ...
                    {departments.map(dept => {
                      ...
                      return (
                        <div 
                          ...
                          className={`relative flex flex-col items-center justify-center p-3 rounded-xl border-2 transition-all cursor-pointer shadow-sm group ${
                            isSelected 
